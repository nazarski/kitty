...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(name: $name, email: $email, pin: $pin, biometrics: $biometrics, avatarLocalPath: $avatarLocalPath)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, email, pin, biometrics, avatarLocalPath);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final String avatarLocalPath}) = _$_User;
